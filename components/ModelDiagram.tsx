        ...
        {modelNodes.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[15px] font-extrabold">{item.short}</span>
            </button>
          );
        })}
      </div>
      ...
      <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2">
        <div className={"relative mx-auto aspect-square w-full " + (compact ? "max-w-[400px]" : "max-w-[480px]")}>
          ...
          >
            ...
            <span className="mt-1 text-center text-[17px] font-extrabold leading-tight">
              Central
              <br />
              Kitchen
            </span>
        ...
        <div role="tabpanel">
          ...
          <h2 className="mb-4 mt-4 text-[clamp(23px,2.9vw,36px)] font-extrabold leading-[1.1]">{node.title}</h2>
